...
export default function HomePage() {
  ...
  return (
    <div>
      {/* Hero Banner */}
      <section className="bg-linear-to-r from-gray-100 to-gray-50 overflow-hidden">
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-linear-to-br from-blue-600 to-blue-700 text-white rounded-lg p-6 flex flex-col justify-between min-h-[180px]">
            <div>
